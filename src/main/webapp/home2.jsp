...
<title>Custom Care System </title>
        ...
        <div class="main-header header-sticky">
            <div class="container-fluid">
                <div class="menu-wrapper d-flex align-items-center justify-content-between">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="home1.jsp"><img src="assets/img/logo/logo2.png" alt=""></a>
                    </div>
                    <!-- Main-menu -->
                    <div class="main-menu f-right d-none d-lg-block">
                        <nav>
                            <ul id="navigation">
								...
								<li><a href="login.jsp">Help Desk</a></li>
...
<main>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay=".4s">Committed to Excellence</span>
                                <h1 data-animation="fadeInLeft" data-delay=".6s">Welcome to VT HELP DESK</h1>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="professional-services section-bg d-none d-md-block" data-background="assets/img/gallery/sup13.jpg"></div>
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                        ...
                        <div class="section-tittle profession-details">
                            ...
                            <h2>About Us</h2>
                            <p>As one of the leading local businesses in the Colombo area, we attribute our reputation to the lasting customer relationships we’ve developed throughout the years. We believe that all of our customers deserve the highest level of service, and we are committed to providing just that.</p>
                            <p>Explore the rest of our site to learn more about what we have to offer, and get in touch with any questions. VT HELP DESK is here for you.</p>
                        </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <a href="about.html" class="btn btn3">Get In Touch</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="cl-xl-7 col-lg-8 col-md-10">
                    ...
                    <div class="section-tittle text-center mb-70">
                        <span>Our Professional Services</span>
                        <h2>Best Customer Care Services</h2>
                    </div> 
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="single-services mb-200">
                        <div class="services-img">
                            ...
                            <h3><a href="services.html">Knowledgebase</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="single-services mb-200">
                        <div class="services-img">
                            ...
                            <div class="services-caption">
                            <h3><a href="services.html">Files</a></h3>
                            <p class="pera1">For each project we establish </p>
                            <p class="pera2">For each project we establish relationships with partners who we know will help us. </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="single-services mb-200">
                        <div class="services-img">
                            ...
                            <div class="services-caption">
                            <h3><a href="services.html">Contact VT support</a></h3>
                            <p class="pera1">For each project we establish </p>
                            <p class="pera2">For each project we establish relationships with partners who we know will help us. </p>
                        </div>
                    </div>
